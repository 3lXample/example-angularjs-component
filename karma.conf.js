...
module.exports = function(config) {
  config.set({
    ...
    htmlReporter: {
      ...
      pageTitle: 'Example AngularJS Web [Component] Unit Tests',
      subPageTitle: 'An example of web made with AngularJS component and NodeJS',
      groupSuites: true,
    ...
    junitReporter: {
      ...
      suite: 'example-angularjs-component',
